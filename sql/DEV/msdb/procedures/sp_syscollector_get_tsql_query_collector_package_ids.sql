...
GRANT EXECUTE ON [sp_syscollector_get_tsql_query_collector_package_ids] TO [dc_operator]
GRANT EXECUTE ON [sp_syscollector_get_tsql_query_collector_package_ids] TO [dc_proxy]
GO
